      ...
      <div className="fixed inset-x-0 top-0 flex flex-row items-center justify-between py-4 px-6 text-white text-xs tracking-wide z-40 max-w-full">
        ...
        <div className="flex flex-row items-center gap-4">
          <a
            ...
            className="font-productsFont font-semibold text-sm bg-[#B89C58] hover:bg-[#D4AF37] text-neutral-900 px-5 py-2 rounded-full transition-all duration-300 hover:shadow-[0_0_20px_rgba(184,156,88,0.3)]"
          >
            Donate
          </a>
          <button
